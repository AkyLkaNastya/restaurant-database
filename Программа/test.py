...
def add_menu_position(menu_items, menu_listbox):
    ...
    add_ingredient_button = ttk.Button(root, text="Добавить ингредиентt", bg="#92B96E", fg="#3F4D38", command=add_ingredient)
    ...
    add_menu_item_button = ttk.Button(root, text="Добаить позицию", bg="#92B96E", fg="#3F4D38", command=add_menu_item)
